...
# Bot information
SESSION = environ.get('SESSION', 'Nh_filtes_Bot')
...
PICS = (environ.get('PICS', 'https://i.imghippo.com/files/GS3653JdU.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6276113288').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6423243970').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002343295673 -1002496432196').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002391071017')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002325240013')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nhmovies9:nhmovies9@cluster0.lp65c.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "nhmovies9")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'nhmovies9')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.imghippo.com/files/MLdp1616AWc.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies_Group_Nh0')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/new_updet')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'greymatters_about') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/greymatters_about')
